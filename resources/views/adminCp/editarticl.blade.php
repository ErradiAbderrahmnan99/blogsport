                ...
                <div class="card-body">
                    ...
                    <form  id="pageForm">
                        ...
                        <div class="form-group text-center">
                            <img src="{{asset('/img/blog/'.$articls->image)}}" style="border: 2px solid #377ce5;max-width: 500px;height: auto">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$articls->title}}" name="title" id="title" placeholder="Articl title">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cate">
                                <optgroup label="Bolog Category">
                                    <option value="{{$cat->id}}">{{$cat->name}}</option>
                                </optgroup>
                                <optgroup label="Other Categorys">
                        ...
                        {{--reference articl--}}
                        <input type="text" style="display: none;" class="form-control" value="{{$articls -> ref}}" name="ref_articl">
                        <input type="text" style="display: none;" class="form-control" value="{{$articls -> ref}}" name="ref_articl">
                        {{--reference articl--}}
